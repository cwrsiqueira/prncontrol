...
@section('content_header')
    <cw-header-title>
        ...
        <x-adminlte-button label="{{__('system.add_lot')}}" data-toggle="modal" data-target="#modalAdd" class="bg-success" icon="fas fa-plus" id="openModalAdd"/>
...
@section('content')
    <x-adminlte-card theme="success" theme-mode="outline" icon="fas fa-th">
        ...
        foreach ($lots as $key => $lot) {
            ...
            $data[$key]['actions'] =
            "<nobr>
                <button class='btn btn-xs btn-default text-primary mx-1 shadow btnAction edit' title='".$system_edit."' data-id='".$lot["id"]."'>
                    <i class='fa fa-lg fa-fw fa-pen'></i>
                </button>
                <button class='btn btn-xs btn-default text-danger mx-1 shadow btnAction delete' title='".$system_delete."' data-id='".$lot["id"]."'>
                    <i class='fa fa-lg fa-fw fa-trash'></i>
                </button>
                <button class='btn btn-xs btn-default text-teal mx-1 shadow btnAction details' title='".$system_details."' data-id='".$lot["id"]."'>
        ...
        {{-- Modal ADD --}}
        <x-adminlte-modal id="modalAdd" title=" {{ __('system.add_lot') }}" size="lg" theme="success" icon="fas fa-th" v-centered static-backdrop scrollable>
        ...
        {{-- Modal EDIT --}}
        <x-adminlte-modal id="modalEdit" title=" {{ __('system.edit_lot') }}" size="lg" theme="success" icon="fas fa-th" v-centered static-backdrop scrollable>
